...
function populateTpl(tweets){
  ...
  for (var i = 0, lgth = tweets.length; i < lgth ; i++) {
    ...
    html += '<hr>'
      ...
      + (tweetObject.image ? '<p><div class="tweet-img"><img src="'+tweetObject.image+'" /></div></p>' : '<p><div class="tweet-img"><img src="images/blank.png" /></div></p>')
      + '</div>'
      + '<div class="large-6 columns">'
      + '<h5> <a href="'+tweetObject.permalinkURL+'"></a></h5>'
      + '<p>'
      + '<span><i class="fi-torso"> @hackersdotmu </i></span>'
      + '<span><i class="fi-calendar">' + tweetObject.time + ' </i></span>'
      + '<span><i class="fi-comments"><a href="'+tweetObject.permalinkURL+'"> Read more </a></i></span>'
      + '</p>'
